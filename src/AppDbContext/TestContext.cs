using System.Data;
using AppDbContext;
using AppDbContext.EntityConfigurations;
...
{
    public const string DEFAULT_SCHEMA = "test";
    ...
    public TestContext(DbContextOptions<TestContext> options, IMediator mediator) : base(options)
    {
        _mediator = mediator ?? throw new ArgumentNullException(nameof(mediator));


        System.Diagnostics.Debug.WriteLine("TestContext::ctor ->" + this.GetHashCode());
    }
...
public class AppDbContextDesignFactory : IDesignTimeDbContextFactory<TestContext>
{
